  ...
  return (
    ...
    >
      <div className="relative z-10 flex gap-4 items-start justify-between w-full">
          ...
          {job.matchScore != null && (
            <div className="flex gap-2 items-center shrink-0 self-center">
              ...
              <div className="text-xl font-bold text-[var(--accent)]">{job.matchScore}%</div>
            </div>
          )}
        </div>
      ...
      <div className="relative z-10 flex items-center justify-between gap-4 w-full">
        ...
        {job.fitCategory && (
          <div className="px-3 py-1 rounded-full bg-[var(--accent)]/20 text-[var(--accent)] text-sm font-medium">
            {job.fitCategory}
          </div>
        )}
      </div>
...
export default GlassmorphicJobCard;
